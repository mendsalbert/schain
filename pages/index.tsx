      ...
      <div className="font-Montserrat mx-4 sm:mx-8 md:mx-12 relative">
        ...
        <div className="mt-36 md:flex md:flex-row-reverse md:items-center md:mt-56">
          ...
          <div>
            ...
            <div className="bg-gradient-to-r italic from-[#0469A1] via-[#0469A1] mt-2 to-[#0C9FF2]  text-center w-max  px-6 py-2 md:py-4 rounded-full cursor-pointer text-white">
              Read More
            </div>
          </div>
        </div>
